      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12"> 
         ...
         transition={{ duration: 0.5}}
          ...
          className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gary-500">{car.description}</p>
            </div>
            {/* Features */}
            <div>
        ...
        className="shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500">
          <p className="flex items-center justify-between text-2xl text-gray-800 font-semibold">{currency} {car.pricePerDay} 
           ...
           <button className="w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium text-white rounded-xl courser-pointer">
            Book Now
            </button>

            <p className="flex flex-col gap-2 items-center"> No credit card required to reserve</p>
